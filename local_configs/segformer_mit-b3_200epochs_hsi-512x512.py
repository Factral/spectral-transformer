...
_base_ = [
    './_base_/models/segformer_mit-b3.py', './_base_/datasets/hsi_facade.py',
...
val_dataloader = dict(batch_size=2, num_workers=12)
test_dataloader = dict(batch_size=2, num_workers=12)
